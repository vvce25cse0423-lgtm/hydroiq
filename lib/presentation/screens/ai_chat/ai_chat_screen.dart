...
class _AiChatScreenState extends ConsumerState<AiChatScreen> {
  ...
  Future<void> _send(String text) async {
    ...
    try {
      ...
      // API failed — fall through to local knowledge base
      try {
        reply = await aiService.sendMessage(trimmed, []);
      } catch (_) {
        reply = '💧 I\'m here to help! Ask me anything about hydration, sleep, steps, or general health.';
      }
    }
