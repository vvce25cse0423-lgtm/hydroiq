...
class _AchievementsRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Fixed, finite list of achievements — no infinite levels
    const badges = <Map<String, Object>>[
      {'emoji': '💧', 'label': 'First Drop',       'day': 1,  'type': 'total'},
      {'emoji': '🌱', 'label': '3-Day Start',       'day': 3,  'type': 'total'},
      {'emoji': '⚡', 'label': '7-Day Streak',      'day': 7,  'type': 'streak'},
      {'emoji': '🔥', 'label': '14-Day Hero',       'day': 14, 'type': 'streak'},
      {'emoji': '🌊', 'label': '21-Day Habit',      'day': 21, 'type': 'streak'},
      {'emoji': '⭐', 'label': '30-Day Legend',     'day': 30, 'type': 'streak'},
      {'emoji': '💎', 'label': '60-Day Diamond',    'day': 60, 'type': 'total'},
      {'emoji': '🏆', 'label': '100-Day Champion',  'day': 100,'type': 'total'},
    ];
